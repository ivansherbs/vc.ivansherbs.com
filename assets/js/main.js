...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        $whatsappButton.on('click', '.whatsapp-button', function (e) {
            var phone = '+31686339615';
            var params = {
                text: 'Hi, I\'d like to discover Ivan Chai.'
            };

            var apilink = 'https://wa.me/' + phone + '/?' + $.param(params);
            window.open(apilink);
        });
        /*END WHATSAPP JS*/
